                            ...
                            <div class="card-body">
                                <form action="./logic/update.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="umur" name="umur" value="<?= $result['umur'];?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="jabatan" class="form-label">Jabatan</label>
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?= $result['jabatan'];?>">
                                    </div>
